...
from assets.config import PRIMARY_LIGHT, PRIMARY_DARK, DIFFICULTY_COLORS
...
<div style='text-align: center; padding: 2rem 0;'>
    <h1 style='color: {PRIMARY_DARK}; margin-bottom: 0.5rem;'>➕ Create Activity</h1>
...
<div style='background: white; padding: 2rem; border-radius: 12px; 
    ...
    <h2 style='color: {PRIMARY_DARK}; margin-top: 0;'>Activity Details</h2>
</div>
""", unsafe_allow_html=True)
